        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        <div id="containerSpeed" style="height: 300px">
                        </div>
                    </div>
                </div>
            </div>
            <div class="span6">
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        <div id="containerEngineSpeed" style="height: 300px">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        <div id="containerEngineTem" style="height: 300px">
                        </div>
                    </div>
                </div>
            </div>
            <div class="span6">
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        <div id="containerEngineLoad" style="height: 300px">
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/page/dev/js/content/vehicle_range_percent_count.js"></script>
