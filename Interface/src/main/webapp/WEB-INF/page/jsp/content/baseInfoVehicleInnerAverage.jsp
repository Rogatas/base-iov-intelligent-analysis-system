...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a class="current">基于汽车ID为维度的均值统计</a>
        </div>
    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/page/dev/js/content/base_info_vehicle_inner_average.js"></script>
